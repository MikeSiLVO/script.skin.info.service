...
KEY_VKEY = 61440
KEY_VMOUSE = 61439
NOTIFICATION_ERROR: int
NOTIFICATION_INFO: int
NOTIFICATION_WARNING: int
PASSWORD_VERIFY = 1
REMOTE_0 = 58
REMOTE_1 = 59
REMOTE_2 = 60
...
class Control:
    ...
    **Code based skin access.**
    ...
    def setLabel(self, label: str = "") -> None:
        """
        Sets text for control label.
        Available on multiple control types (ControlButton, ControlLabel, etc).
        """
        pass
    ...
    def getSelectedItem(self) -> 'ListItem':
        ...
        Available on ControlList subclasses.
        """
...
class Dialog:
    ...
    **Kodi's dialog class**
    ...
    def select(self, heading: str,
               list: Sequence[Union[str,  'ListItem']],
               autoclose: int = 0,
               preselect: int = -1,
